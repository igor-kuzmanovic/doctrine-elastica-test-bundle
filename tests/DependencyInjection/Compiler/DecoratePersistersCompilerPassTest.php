...
namespace Kuzman\DoctrineElasticaTestBundle\Tests\DependencyInjection\Compiler;
...
final class DecoratePersistersCompilerPassTest extends TestCase
{
    public function testDecoratesOnlyCompatiblePersisters(): void
    {
        ...
        self::assertTrue($container->hasDefinition('kuzman_doctrine_elastica_test.tracking_object_persister.foo'));
        self::assertFalse($container->hasDefinition('kuzman_doctrine_elastica_test.tracking_object_persister.app'));

        $decorator = $container->getDefinition('kuzman_doctrine_elastica_test.tracking_object_persister.foo');
        ...
        self::assertSame('kuzman_doctrine_elastica_test.tracking_object_persister.foo.inner', (string) $innerArgument);
